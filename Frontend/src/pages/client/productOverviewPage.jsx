...
>
  <div className="w-[500px] h-[600px] flex flex-col  rounded-3xl  p-6 ">
    ...
    <motion.h1
      ...
      className="text-4xl font-bold text-secondary text-left  "
    >
      {product.productName}
    ...
    <motion.h2
      ...
      className="text-right my-2 text-md text-gray-300 font-semibold"
    ...
    <motion.p
      ...
      className="text-justify my-2 text-gray-700 leading-relaxed"
    >
      {product.description}
    </motion.p>
    ...
    >
      {product.lablePrice > product.Price ? (
        <div>
          ...
          <span className="text-3xl font-bold text-accent ml-4">
            ${product.Price}
          </span>
        </div>
      ) : (
    ...
    >
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="w-[200px] h-[50px] bg-gradient-to-r bg-new
      ...
      <motion.button
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className="w-[200px] h-[50px] bg-gradient-to-r from-green-200 to-teal-200 
                   text-accent rounded-2xl shadow-lg font-semibold 
                   transition-all duration-300 cursor-pointer"
        onClick={()=>{
